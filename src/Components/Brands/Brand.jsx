...
export default function Brand() {
 ...
 console.log(id);
  ...
  {details?
   ...
   {details.map((product)=>   <div key={product._id} className="col-md-2">
  <Link to={`/productDetails/${product._id}`}>
  <div className="product cursor-pointer px-2 py-4 text-center" data-aos='flip-down' data-aos-duration="1500">
